...
public class EmailSender(ILogger<EmailSender> logger, EmailClient emailClient)
{
    ...
    public async Task Run([ServiceBusTrigger("email_provider", Connection = "ServiceBus")] ServiceBusReceivedMessage message, ServiceBusMessageActions messageActions)
    {
        try
        {
